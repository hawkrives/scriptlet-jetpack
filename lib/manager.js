...
function addScriptlet(details) {
  readdScriptlet(details);

  notifications.notify({
    title: "Scriptlet Installed!",
    text: details.title + " was installed!",
    onClick: function (data) {
      // TODO open scriptlet in AOM
    }
  });
}
exports.addScriptlet = addScriptlet;

function readdScriptlet(details) {
...
exports.readdScriptlet = readdScriptlet;
